...
namespace TextAdventure
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(name + " finaly walked in");
            ...
            Console.WriteLine("It's a very sad story i dont normaly talk about");
            ...
            if ( hearStory == "yes")
            {
                ...
                Console.WriteLine("Actualy they were very simialar to yours.");
            ...
            Console.WriteLine("I had no buisness raising a child");
            Console.WriteLine("When I was still a child myself");
            Console.WriteLine("I never spoke to him agian but i still think about");
